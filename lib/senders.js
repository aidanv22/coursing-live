...
export function appUrl() {
  ...
  // In production, a missing APP_URL means every password reset and
  // unsubscribe link generated would silently be broken (a relative path
  // with no domain, unclickable in an email client) — better to fail
  // loudly here than send customers a dead link.
  throw new Error('APP_URL is not configured — required in production for reset/unsubscribe links.');
}
